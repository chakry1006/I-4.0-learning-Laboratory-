...
while(digitalRead(21))
{
  ...
  while (digitalRead(35)) {
    Serial.println("In loop 35");// swap pins when belt is struck at left swtitch
    digitalWrite(32, LOW);
